    ...
    >
      ...
      <div className="flex flex-col gap-3 mt-5">
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="col-span-1 relative flex flex-col gap-3">
            <Image
              ...
              height={769}
            />
            <div className="flex gap-3 w-[400px] ml-17">
              <Button
                onClick={onDeleteDomain}
                variant="destructive"
                type="button"
                className="flex-1 h-[40px] bg-red-600 hover:bg-red-700 text-white font-semibold text-sm"
              >
                <Loader loading={deleting}>Delete Domain</Loader>
              </Button>
              <Button
                type="submit"
                className="flex-1 h-[40px] bg-black text-white hover:bg-gray-800 font-semibold text-sm"
              >
      ...
      {/* Buttons moved below - commented out old location
